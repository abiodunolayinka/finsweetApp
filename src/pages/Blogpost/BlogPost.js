  ...
  return (
    <div class="sm:mx-4 w-10/12 w-11/12 m-auto">
      <div class="max-w-11/12">
        <div class="m-auto w-7/12 sm:m-auto items-center sm:m-5 justify-center py-10 text-center">
      ...
      <div class="m-auto sm:w-7/12 sm:m-auto  sm:m-5 justify-center py-10 text-center">
      ...
      <div class="m-auto sm:w-7/12 sm:m-auto items-center sm:m-5 justify-center py-10 text-center">
        <h1 class="text-3xl sm:text-5xl font-bold mb-2 text-lg text-center ">
          New invoicing features to help you get paid faster
        </h1>
        <p class=" font-semibold">
